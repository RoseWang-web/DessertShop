/*
 * File: Lab12b.java
 * Description:  setting tree's function
 * Lessons Learned:
 * Combine simply shapes to create an object (a tree)
 ...
 *
 * When creating a Tree object in the 1
 * DrawPanel.paintComponent(Graphics) method, usually the following syntax is used.
 *
...
public class Tree extends LandscapeObject{
	...
	private void drawBranches() {
		...
		int[] xPoints1 = {currentX, currentX+branchWidth, currentX+(branchWidth/2)};
		int decrease=0;
		for(int i=0; i<levels;i++){
			decrease=(int)(i*branchHeight*branchOverlap);
			int[] yPoints1 = {currentY-decrease,currentY-decrease,currentY-branchHeight-decrease};
